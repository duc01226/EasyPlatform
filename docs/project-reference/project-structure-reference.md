...
| -------------------------------------- | -------------------------------------------------------------- | ---------------------------------------------------- |
| Easy.Platform                          | Core: CQRS, validation, repositories, message bus abstractions | src/Platform/Easy.Platform/                          |
| Easy.Platform.AspNetCore               | ASP.NET Core integration (middleware, controllers)             | src/Platform/Easy.Platform.AspNetCore/               |
| Easy.Platform.EfCore                   | Entity Framework Core persistence provider                     | src/Platform/Easy.Platform.EfCore/                   |
...
| ----------------------- | ---------------------------------------------------------------- | ------------------------------------------ |
| platform-core           | Framework core: base components, stores, API services, utilities | src/Frontend/libs/platform-core/           |
| platform-components     | Reusable Angular UI components                                   | src/Frontend/libs/platform-components/     |
| apps-domains            | Shared domain models and services (TextSnippet domain)           | src/Frontend/libs/apps-domains/            |
...
| --------------------- | ------- | -------------------------------- |
| .NET                  | 9.0     | Runtime for all backend projects |
...
| Selenium Grid           | 4.8.3        | Browser automation testing |
...
| ------------------------------------------------- | ---------------------------- | -------- |
| start-dev-platform-example-app.cmd                | Default startup (PostgreSQL) | Postgres |
...
| start-dev-platform-example-app-RESET-DATA.cmd     | Clear volumes + restart      | -        |

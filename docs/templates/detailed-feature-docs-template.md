...
**Location**: `src/Backend/{Module}.Domain/Entities/{Entity}.cs`
...
**Location**: `src/Backend/{Module}.Domain/Enums/{EnumName}.cs`
...
| --------------- | -------------- | ------------ | -------------- | -------------------- |
| {Page}Component | Container      | Main page    | {Feature}Store | `apps/{module}/.../` |
| {List}Component | Presentational | List display | -              | `apps/{module}/.../` |
| {Form}Component | Form           | Create/Edit  | -              | `apps/{module}/.../` |
...
**Location**: `src/Backend/{Module}.Api/Controllers/{Feature}Controller.cs`
...
_Generated following EasyPlatform Documentation Standards v2.0_

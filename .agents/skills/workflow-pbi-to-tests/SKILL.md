...
**Goal:** [Workflow] Trigger PBI to Tests workflow — qa workflow: generate tdd test specs from pbi, write to feature docs section 15, run quality gate.
...
- MUST ATTENTION require every generated TC to include `Business Intent / Invariant Guarded` and fail if that intent breaks.
- NEVER skip mandatory workflow or skill gates.

**IMPORTANT MANDATORY Steps:** $tdd-spec -> $why-review -> $tdd-spec-review -> $quality-gate -> $workflow-end
...
**Steps:** $tdd-spec → $why-review → $tdd-spec-review → $quality-gate → $workflow-end

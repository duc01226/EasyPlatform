---
name: plan-ci
description: '[Planning] Use when you need to analyze GitHub Actions logs and provide a plan to fix the issues.'
...
> **Skill Variant:** Variant of `$plan-hard` — specialized for CI/GitHub Actions failure analysis.

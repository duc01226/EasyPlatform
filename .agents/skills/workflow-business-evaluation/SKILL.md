...
**IMPORTANT MANDATORY Steps:** $web-research -> $deep-research -> $market-analysis -> $business-evaluation -> $knowledge-review -> $workflow-end
...
**Goal:** [Workflow] Trigger Business Idea Evaluation workflow — research market, evaluate business idea viability with bmc, financials, risk matrix, and execution plan.

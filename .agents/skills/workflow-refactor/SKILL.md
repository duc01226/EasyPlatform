...
**IMPORTANT MANDATORY Steps:** $scout -> $investigate -> $plan-hard -> $why-review -> $plan-review -> $why-review -> $plan-validate -> $why-review -> $code -> $tdd-spec -> $why-review -> $tdd-spec-review -> $tdd-spec [direction=sync] -> $integration-test -> $integration-test-review -> $integration-test-verify -> $workflow-review-changes -> $sre-review -> $changelog -> $test -> $docs-update -> $watzup -> $workflow-end
...
**Steps:** $scout → $investigate → $plan-hard → $why-review → $plan-review → $why-review → $plan-validate → $why-review → $code → $tdd-spec → $why-review → $tdd-spec-review → $tdd-spec [direction=sync] → $integration-test → $integration-test-review → $integration-test-verify → $workflow-review-changes → $sre-review → $changelog → $test → $docs-update → $watzup → $workflow-end

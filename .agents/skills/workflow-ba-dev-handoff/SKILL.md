...
**IMPORTANT MANDATORY Steps:** $review-artifact -> $quality-gate -> $handoff -> $plan-hard -> $plan-review -> $plan-validate -> $workflow-end
...
**Steps:** $review-artifact → $quality-gate → $handoff → $plan-hard → $plan-review → $plan-validate → $workflow-end
...
**Goal:** [Workflow] Trigger BA to Dev Handoff workflow — ba hands off refined stories to development team with quality gate.

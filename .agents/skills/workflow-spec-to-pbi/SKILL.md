...
**IMPORTANT MANDATORY Steps:** $scout -> $spec-discovery -> $domain-analysis -> $why-review -> $plan-hard -> $why-review -> $plan-review -> $why-review -> $plan-validate -> $why-review -> $refine -> $why-review -> $refine-review -> $story -> $why-review -> $story-review -> $pbi-challenge -> $dor-gate -> $pbi-mockup -> $prioritize -> $docs-update -> $watzup -> $workflow-end

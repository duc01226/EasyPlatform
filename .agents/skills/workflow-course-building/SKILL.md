...
**IMPORTANT MANDATORY Steps:** $web-research -> $deep-research -> $course-builder -> $knowledge-review -> $workflow-end
...
**Goal:** [Workflow] Trigger Course Material Builder workflow — research a topic and build structured learning/teaching course material with bloom taxonomy objectives.

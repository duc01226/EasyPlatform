...
**IMPORTANT MANDATORY Steps:** $prioritize -> $dependency -> $team-sync -> $workflow-end
...
**Goal:** [Workflow] Trigger Sprint Planning workflow — sprint planning ceremony with backlog prioritization and dependency check.

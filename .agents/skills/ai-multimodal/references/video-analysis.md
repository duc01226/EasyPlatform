...
> **Note**: This guide covers video _analysis_ (understanding existing videos). For video _generation_ (creating new videos), see [Video Generation Reference](./video-generation.md).

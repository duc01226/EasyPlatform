...
**IMPORTANT MANDATORY Steps:** $web-research -> $deep-research -> $market-analysis -> $strategy-builder -> $knowledge-review -> $workflow-end
...
**Goal:** [Workflow] Trigger Marketing Strategy workflow — research market landscape and build a comprehensive marketing strategy with positioning, channels, campaigns, and kpis.

---
name: cook-fast
description: '[Implementation] Use when you need fast implementation - skip research, minimal planning.'
---
...
1. **Quick Planning** (skip research phase)
    ...
    - Create minimal todo list with task tracking
...
4. **Commit** (optional)
    - Ask user if ready to commit via a direct user question
    - If yes, use `$commit`

...
**If Step A did NOT suppress AND Step B gate fires**, immediately follow with a **SECOND** a direct user question invocation (separate from the existing `## Next Steps` call — do NOT merge bullet lists):

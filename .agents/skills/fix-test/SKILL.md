...
- Verify each hypothesis against an actual code trace before acting — never assume the first hypothesis is correct — why: the first guess is often the nearest-attention trap, not the cause

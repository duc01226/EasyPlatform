...
**IMPORTANT MANDATORY Steps:** $quality-gate -> $plan-hard -> $plan-review -> $plan-validate -> $workflow-end
...
**Steps:** $quality-gate → $plan-hard → $plan-review → $plan-validate → $workflow-end
...
**Goal:** [Workflow] Trigger Pre-Development Check workflow — quality gate verification before development begins.

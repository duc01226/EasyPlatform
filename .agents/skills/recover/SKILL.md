...
- Always restore task tracking items before resuming any work
...
**IMMEDIATELY call task tracking** with the pending todos from the checkpoint:
...
- [ ] Restored todo items via task tracking
...
3. **Verify todo status** - Compare checkpoint todos with current task tracking state
...
3. Restoring task tracking items...
   [Calling task tracking with 3 pending items]

...
**IMPORTANT MANDATORY Steps:** $scout -> $investigate -> $plan-hard -> $why-review -> $plan-review -> $why-review -> $plan-validate -> $why-review -> $code -> $integration-test -> $integration-test-review -> $integration-test-verify -> $workflow-review-changes -> $sre-review -> $test -> $docs-update -> $watzup -> $workflow-end
...
**Steps:** $scout → $investigate → $plan-hard → $why-review → $plan-review → $why-review → $plan-validate → $why-review → $code → $integration-test → $integration-test-review → $integration-test-verify → $workflow-review-changes → $sre-review → $test → $docs-update → $watzup → $workflow-end
...
**Goal:** [Workflow] Trigger Deployment & Infrastructure workflow — CI/CD pipelines, Docker, Kubernetes setup and deployment.

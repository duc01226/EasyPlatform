---
name: fix-ui
description: '[Implementation] Use when you need to analyze and fix UI issues.'
...
> **⚠️ Validate Before Fix (NON-NEGOTIABLE):** After identifying UI root cause, MUST ATTENTION present findings + proposed fix to user via a direct user question and get explicit approval BEFORE any code changes. No silent fixes.

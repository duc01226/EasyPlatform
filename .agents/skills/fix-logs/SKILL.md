---
name: fix-logs
description: '[Implementation] Use when you need to analyze logs and fix issues.'
...
5. **🛑 Present root cause + fix plan → a direct user question → wait for user approval.**

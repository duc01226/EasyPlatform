                            ...
                            u = {
                                ...
                                secondary: function (e) {
                                    var t = 'right' === e ? 'left' : 'top',
                                        n = h[t];
                                    return (
                                        h[e] > l[e] && !i.escapeWithReference && (n = Math.min(h[t], l[e] - ('right' === e ? h.width : h.height))),
                                        Ye({}, t, n)
                                    );
                                }
                            };
                        ...
                        return (
                            b.forEach(function (e, t) {
                                ...
                                var n = m.offsets.popper,
                                    ...
                                    f =
                                        !!g.flipVariations &&
                                        ((u && 'start' === E && s) || (u && 'end' === E && a) || (!u && 'start' === E && l) || (!u && 'end' === E && c)),
                                    d =
                                        !!g.flipVariationsByContent &&
                                        ((u && 'start' === E && a) || (u && 'end' === E && s) || (!u && 'start' === E && c) || (!u && 'end' === E && l)),
                                    p = f || d;
                                (r || h || p) &&
                                    ((m.flipped = !0),
                                    (r || h) && (v = b[t + 1]),
                    ...
                    if (!this._element.disabled && !p(this._element).hasClass(xt) && p(this._menu).hasClass(jt)) {
                        ...
                        (p(n).trigger(t),
                            t.isDefaultPrevented() ||
                                (this._popper && this._popper.destroy(), p(this._menu).toggleClass(jt), p(n).toggleClass(jt).trigger(p.Event(Pt.HIDDEN, e))));
                    }
                }),
                (e.dispose = function () {
                ...
                (c._dataApiKeydownHandler = function (e) {
                    if (
                        (/input|textarea/i.test(e.target.tagName)
                            ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || p(e.target).closest(qt).length)))
                            : Lt.test(e.which)) &&
            ...
            return (
                ...
                (e._getConfig = function (e) {
                    ...
                    return (
                        ...
                        'number' == typeof (e = l({}, this.constructor.Default, {}, t, {}, 'object' == typeof e && e ? e : {})).delay &&
        ...
        Vi = (function () {
            ...
            return (
                (e.show = function () {
                    ...
                    if (
                        !(
                            (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(ji)) ||

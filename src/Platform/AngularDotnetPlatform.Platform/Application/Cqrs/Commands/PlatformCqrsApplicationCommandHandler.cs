...
{
    public abstract class PlatformCqrsApplicationCommandHandler<TCommand, TResult> : PlatformCqrsApplicationRequestHandler<TCommand>, IRequestHandler<TCommand, TResult>
        ...
        where TResult : PlatformCqrsCommandResult, new()
    {
        ...
        public PlatformCqrsApplicationCommandHandler(
    ...
    public abstract class PlatformCqrsCommandHandler<TCommand> : PlatformCqrsApplicationCommandHandler<TCommand, PlatformCqrsCommandResult>

...
public class PlatformRabbitMqMessageBusProducer : IPlatformMessageBusProducer
{
    ...
    {
        using (
            var activity = IPlatformMessageBusProducer.ActivitySource.StartActivity($"MessageBusProducer.{nameof(IPlatformMessageBusProducer.SendAsync)}", ActivityKind.Producer)
        )
        {

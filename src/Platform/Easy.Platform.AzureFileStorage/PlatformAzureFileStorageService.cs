...
public class PlatformAzureFileStorageService : IPlatformFileStorageService
{
    ...
    {
        var blobClient = GetBlobClient(tryRemoveFilePathSpecialCharactersUri ? fullFilePath.RemoveSpecialCharactersUri() : fullFilePath);
    ...
    {
        var blobClient = GetBlobClient(rootDirectory, tryRemoveFilePathSpecialCharactersUri ? filePath.RemoveSpecialCharactersUri() : filePath);

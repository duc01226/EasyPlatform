    ...
    where TDbContext : PlatformEfCoreDbContext<TDbContext>
{
    ...
    {
        var options = PooledDbContextOptions();
    ...
    {
        serviceCollection.RegisterAllFromType<IPlatformEfCorePersistenceUnitOfWork<TDbContext>>(GetAssembliesForServiceScanning());

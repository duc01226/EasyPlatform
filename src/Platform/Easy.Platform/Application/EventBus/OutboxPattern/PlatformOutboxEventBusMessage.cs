...
namespace Easy.Platform.Application.EventBus.OutboxPattern
{
    public class PlatformOutboxEventBusMessage : RootEntity<PlatformOutboxEventBusMessage, string>, IRowVersionEntity
    {
        ...
        public static PlatformOutboxEventBusMessage Create<TMessage>(
            TMessage message,
            string routingKey,
            SendStatuses sendStatus,
            string lastSendError = null) where TMessage : IPlatformEventBusTrackableMessage
        {
        ...
        private static void EnsureMessageValidForOutbox(IPlatformEventBusTrackableMessage message)
        {

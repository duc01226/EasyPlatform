...
public static class PlatformApplicationCommonRequestContextKeys
{
    ...
    public const string ConsumerOrEventHandlerPipeLineKey = "ConsumerOrEventHandlerPipeLine";

    public static List<string> ConsumerOrEventHandlerPipeLine(this IDictionary<string, object?> context)
    {
        return context.GetRequestContextValue<List<string>>(ConsumerOrEventHandlerPipeLineKey) ?? [];
    }

    public static void SetConsumerOrEventHandlerPipeLine(this IDictionary<string, object?> context, List<string> values)
    {
        context.SetRequestContextValue(values, ConsumerOrEventHandlerPipeLineKey);
    }

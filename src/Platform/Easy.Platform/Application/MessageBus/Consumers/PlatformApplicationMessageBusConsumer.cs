...
namespace Easy.Platform.Application.MessageBus.Consumers
{
    ...
    public abstract class PlatformApplicationMessageBusConsumer<TMessagePayload> :
        PlatformApplicationBusFreeFormatMessageConsumer<PlatformBusMessage<TMessagePayload>>,
        IPlatformApplicationMessageBusConsumer<TMessagePayload>
        where TMessagePayload : class, new()
    {

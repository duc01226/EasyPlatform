    ...
    where TMessage : class, new()
{
    ...
    private void ProcessConsumerPipeLineInRequestContext(TMessage message, string routingKey)
    {
        ...
        var requestContextConsumerPipeLine =
            trackableBusMessage.RequestContext.GetRequestContextValue<List<string>>(IPlatformApplicationMessageBusConsumer.RequestContextConsumerPipeLineKey) ?? [];
        ...
        message.As<IPlatformTrackableBusMessage>()
            .RequestContext.Upsert(IPlatformApplicationMessageBusConsumer.RequestContextConsumerPipeLineKey, requestContextConsumerPipeLine);

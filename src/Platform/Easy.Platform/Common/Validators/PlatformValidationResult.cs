...
public class PlatformValidationResult<TValue> : ValidationResult
{
    ...
    {
        return new PlatformValidationResult(validation.Errors);
    }
    ...
    /// <inheritdoc cref="ValidIf(TValue,bool,Easy.Platform.Common.Validators.PlatformValidationFailure[])"/>
    public static PlatformValidationResult<TValue> ValidIf(
        TValue value,
        Func<bool> must,
        params PlatformValidationFailure[] errors)
    {
        return ValidIf(value, must(), errors);
    }
    ...
    /// <summary>
    /// Throw exception provided from <see cref="exception"/>
    /// </summary>
    public TValue EnsureValid(Func<PlatformValidationResult<TValue>, Exception> invalidException)
    {
        return IsValid ? Value : throw invalidException(this);
    }
...
public class PlatformValidationResult : PlatformValidationResult<object>
{
    ...
    public static PlatformValidationResult ValidIf(
        ...
        params PlatformValidationFailure[] errors)
    {
        return must ? Valid() : Invalid(errors);
    }

    /// <inheritdoc cref="ValidIf(bool,Easy.Platform.Common.Validators.PlatformValidationFailure[])"/>
    public static PlatformValidationResult ValidIf(

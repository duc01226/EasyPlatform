...
public static class EnsureThrowDomainExceptionExtension
{
    ...
    {
        validationResultFns.ForEach(validationResultFn =>
        {
    ...
    {
        await validateActions.ForEachAsync(async validateAction =>
        {
            ...
            .Select<IValidatableEntity<TEntity, TPrimaryKey>, Func<Task<PlatformValidationResult>>>(entity =>
                () =>
                    entity
                        ...
                        .Validate(checkAnyDuplicatedItemAsyncFunction: async findOtherDuplicatedItemPredicate =>
    ...
    public static void EnsureEntitiesValid<TEntity, TPrimaryKey>(this List<TEntity> entities)
        where TEntity : IEntity<TPrimaryKey>
    {

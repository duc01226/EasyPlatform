...
/// <summary>
/// Provides extension methods for automatically adding field updated domain events to entities.
/// </summary>
public static class AutoAddFieldUpdatedEventEntityExtensions
{
    /// <summary>
    /// A cached dictionary to store whether a type has the <see cref="TrackFieldUpdatedDomainEventAttribute"/>.
    /// </summary>
    ...
    /// <param name="existingOriginalEntity">The original entity instance before updates.</param>
    /// <returns>The entity with the added domain events.</returns>
    public static TEntity AutoAddFieldUpdatedEvent<TEntity>(this TEntity entity, TEntity existingOriginalEntity)
    ...
    public static bool HasTrackValueUpdatedDomainEventAttribute<TEntity>(this TEntity entity)
        where TEntity : IEntity
    {
        return entity is ISupportDomainEventsEntity<TEntity>
            && (
                TypeToHasTrackValueUpdatedDomainEventAttributeCachedResultDict.GetOrAdd(
                    entity.GetType(),
                    CheckTypeHasTrackValueUpdatedDomainEventAttribute
                )
                || TypeToHasTrackValueUpdatedDomainEventAttributeCachedResultDict.GetOrAdd(
                    typeof(TEntity),
                    CheckTypeHasTrackValueUpdatedDomainEventAttribute

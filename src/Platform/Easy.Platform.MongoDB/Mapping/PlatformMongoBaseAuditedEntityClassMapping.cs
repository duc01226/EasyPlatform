...
namespace Easy.Platform.MongoDB.Mapping
{
    ...
    public abstract class
        PlatformMongoBaseAuditedEntityClassMapping<TEntity, TPrimaryKey, TUserId> : IPlatformMongoClassMapping
        where TEntity : AuditedEntity<TEntity, TPrimaryKey, TUserId>, new()
    {
        public PlatformMongoBaseAuditedEntityClassMapping()
        {
            ...
            BsonClassMap.RegisterClassMap<AuditedEntity<TEntity, TPrimaryKey, TUserId>>(
                BaseAuditedEntityClassMapInitializer);
        ...
        public virtual void BaseAuditedEntityClassMapInitializer(
            BsonClassMap<AuditedEntity<TEntity, TPrimaryKey, TUserId>> cm)
        {
            cm.AutoMap();
            cm.SetDiscriminatorIsRequired(true);
            cm.SetIgnoreExtraElements(true);

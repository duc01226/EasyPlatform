...
namespace ApiJwtAuthenticationExample.Auth
{
    ...
    public class AuthenticateController : Controller
    {
        ...
        {
            return await Register(request, withRoles: new List<string>() { UserRoles.User });
        }
        ...
        {
            return await Register(request, withRoles: new List<string>() { UserRoles.Admin, UserRoles.User });
        }

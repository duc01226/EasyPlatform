import { asyncScheduler, BehaviorSubject, concat, Observable, of, PartialObserver } from 'rxjs';
...
export abstract class PlatformCachingService {
     ...
     * @returns Partial PartialObserver with next and error handlers
     *
     * @remarks
 ...
 * They can the default service configuration on a per-request basis.
 */

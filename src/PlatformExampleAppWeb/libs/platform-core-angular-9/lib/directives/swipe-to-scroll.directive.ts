import { AfterViewInit, ChangeDetectorRef, Directive, ElementRef, Injector, ViewContainerRef } from '@angular/core';
 ...
 */
@Directive({ selector: '[platformSwipeToScroll]' })
export class SwipeToScrollDirective extends PlatformDirective implements AfterViewInit {
    ...
    constructor(
        ...
        super(changeDetector, elementRef, cacheService, toast, translateSrv, viewContainerRef, injector);
    }

 ...
 */
export function toPlainObj<T extends object>(source: T, ignorePrivate: boolean = true, onlyKeysExistInPartialObject?: object): any {
...
function assignOrSetDeep<T extends object>(
    ...
    if (currentDeepLevel == null) currentDeepLevel = 1;

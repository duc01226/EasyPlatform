...
export class PlatformDomainModule {
    ...
    public static forRoot(config: {
        ...
        const repositoryProviders = this.buildRepositoryRelatedProviders({
        ...
        const additionalProviders = config.additionalProviders != null ? config.additionalProviders : [];
        const allProviders = repositoryProviders.concat(additionalProviders);

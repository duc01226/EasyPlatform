...
export class PlatformGlobalErrorHandler extends ErrorHandler {
     ...
     * ```
     */
    constructor(private readonly cacheService: PlatformCachingService, @Optional() private readonly servcieWorkerSvc: PlatformServiceWorkerService) {
        super();
    }

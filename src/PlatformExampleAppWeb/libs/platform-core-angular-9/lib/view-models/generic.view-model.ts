...
export class PlatformVm implements IPlatformVm {
     ...
     *
     * @param [data] - Initial data to populate the view model
     *
     * @example
     * ```typescript
     ...
     *
     * @returns True if status is 'Reloading'
     *
     * @example
     * ```typescript
     ...
     *
     * @returns True if status is 'Success' and no error exists
     *
     * @example
     * ```typescript
     * // Show data content
     ...
     *
     * @returns True if status is 'Success' or 'Reloading' and no error exists
     *
     * @example
     * ```typescript
     ...
     *
     * @returns True if status is 'Error' or any error message exists
     *
     * @example
     * ```typescript
     * // Show error UI
     ...
     *
     * @param [requestKeys] - Specific request keys to include. If undefined, includes all keys
     * @param [excludeKeys] - Request keys to exclude from the result
     ...
     * @param [requestKey='Default'] - Unique identifier for the request operation
     *
     * @example
     * ```typescript
     ...
     *
     * @param [requestKey='Default'] - Request key to get error for
     * @returns Error message for the specified request or undefined
     *
     * @example
     * ```typescript
     ...
     *
     * @param value - Loading state to set
     * @param [requestKey='Default'] - Unique identifier for the request operation
     *
     * @example
     * ```typescript
     ...
     * useful for showing different UI indicators.
     *
     * @param value - Reloading state to set
     * @param [requestKey='Default'] - Unique identifier for the request operation
     *
     * @example
     * ```typescript
     ...
     *
     * @param [requestKey='Default'] - Request key to check
     * @returns True if the specified operation is loading
     *
     * @example
     * ```typescript
     ...
     *
     * @param [requestKey='Default'] - Request key to check
     * @returns True if the specified operation is reloading
     *
     * @example
     * ```typescript
     * // Check reload state
     ...
     *
     * @returns True if any operation is reloading
     *
     * @example
     * ```typescript

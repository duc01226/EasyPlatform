 ...
 *
 * @param errorKey - The validation error key used in ValidationErrors object
 * @param startFn - Function that extracts the start value from form control
 * @param endFn - Function that extracts the end value from form control
 * @param [options] - Configuration options for the validator
 * @param [options.allowEqual=true] - Whether equal values are considered valid
 * @param [options.checkDatePart='default'] - Date comparison mode
 * @param [options.condition] - Conditional function to determine when to validate
 * @param [options.errorMsg] - Custom error message template
...
export function startEndValidator<T extends number | Date>(
    errorKey: string,
    startFn: (control: FormControl) => T,
    endFn: (control: FormControl) => T,
    options: {
        allowEqual?: boolean;
 ...
 *
 * @param value - The value to be parsed and converted
 * @returns The converted value as either a Date object or number
 *
 * @internal
 *
 * @example
 ...
 *
 * @param start - The start date/time or numeric value from validation
 * @param end - The end date/time or numeric value from validation
 * @param [errorMsg] - Custom error message template with parameter placeholders

 ...
 * ```
 *
 * @param condition - Function that determines whether to apply validation
 * @param validatorFn - Factory function that returns the validator to apply
 * @returns A conditional validator function compatible with Angular reactive forms
 *
 * @example
 * ```typescript
 ...
 * ```
 *
 * @param condition - Function that determines whether to apply async validation
 * @param validatorFn - The async validator function to apply when condition is true
 * @returns A conditional async validator function compatible with Angular reactive forms
 *
 * @example
 * ```typescript

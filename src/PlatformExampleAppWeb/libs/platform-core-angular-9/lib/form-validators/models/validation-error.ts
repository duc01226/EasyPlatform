 ...
 * ```
 *
 * @param validationErrorOrMsg - Error object or string message
 ...
 *
 * @param key - The validation error key (used in ValidationErrors object)
 * @param validationErrorOrMsg - Error object or message
 * @returns Angular-compatible ValidationErrors object
 *
 * @example
 * ```typescript

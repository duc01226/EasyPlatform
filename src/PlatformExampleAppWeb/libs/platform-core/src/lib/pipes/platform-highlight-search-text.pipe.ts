...
export class PlatformHighlightSearchTextPipe extends PlatformPipe<string | undefined, string | undefined, string | undefined | SafeHtml> implements PipeTransform {

...
export class Time implements ITime {
    ...
    public toString(): string {
        return `${number_formatLength(this.hour, 2)}` + `:${number_formatLength(this.minute, 2)}` + `:${number_formatLength(this.second, 2)}`;
    }
     ...
     * ```
     */
    public static isTimeInRange(from: Time | undefined, to: Time | undefined, time: Time | undefined, isIncludedFrom?: boolean, isIncludedTo?: boolean): boolean {

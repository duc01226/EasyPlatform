...
import { DefaultPlatformHttpOptionsConfigService, PlatformApiErrorEvent, PlatformApiErrorEventHandler, PlatformApiService, PlatformHttpOptionsConfigService } from './api-services';
        ...
        return [
            {
                ...
                providers: [
                    ...
                    {
                        provide: PlatformEventManagerSubscriptionsMap,
                        useValue: new PlatformEventManagerSubscriptionsMap(config.appApiErrorEventHandlers ? [[PlatformApiErrorEvent, config.appApiErrorEventHandlers]] : []),
                        multi: true
                    }
                ]
            },

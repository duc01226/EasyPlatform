...
import { PlatformAuthHttpRequestOptionsAppenderService } from '../../AuthServices';
import { HttpClientOptions, PlatformHttpService } from '../../HttpServices';
...
export abstract class PlatformApiService extends PlatformHttpService {
  ...
  protected catchHttpError<T>(errorResponse: HttpErrorResponse | Error): Observable<T> {
    if (errorResponse instanceof Error) {
      return this.throwError<T>({ error: { code: errorResponse.name, message: errorResponse.message } });
    }

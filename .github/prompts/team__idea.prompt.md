...
Create a structured idea artifact for backlog consideration with business context awareness.
...
2. Ask user with concrete options (use Copilot chat)
...
- Output: "Idea captured and validated! To refine into a PBI, run: `/team__refine {filename}`"
...
```bash
/team__idea "Advanced search filters for snippets"
```

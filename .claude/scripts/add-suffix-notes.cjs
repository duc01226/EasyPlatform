 ...
 * Usage: node add-suffix-notes.cjs [--dry-run] [--type=skills]
 *
...
function main() {
    ...
    // Process commands (deprecated - commands migrated to skills)
    if (type === 'commands') {
        console.log(`\n📁 Commands have been migrated to skills. Use --type=skills instead.`);
    }

    if (false) {
        // Legacy commands processing - kept for reference

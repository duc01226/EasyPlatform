 ...
 *   - .claude/workflows/development-rules.md → dev rules
...
const DEV_RULES_PATH = path.join(ROOT, '.claude', 'workflows', 'development-rules.md');
...
function main() {
    ...
    if (fs.existsSync(DEV_RULES_PATH)) {
        console.log(`Source: .claude/workflows/development-rules.md`);
    }

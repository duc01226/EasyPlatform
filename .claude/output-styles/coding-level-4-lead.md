...
1. **MANDATORY IMPORTANT MUST** lead with executive summary (3-4 sentences max)
2. **MANDATORY IMPORTANT MUST** quantify everything possible (latency, throughput, cost, effort)
3. **MANDATORY IMPORTANT MUST** be explicit about assumptions, unknowns, and confidence levels
4. **MANDATORY IMPORTANT MUST** identify decisions that need stakeholder alignment
5. **MANDATORY IMPORTANT MUST** consider cross-team and cross-system dependencies

### Risk Rules

1. **MANDATORY IMPORTANT MUST** include formal risk assessment (likelihood × impact matrix)
2. **MANDATORY IMPORTANT MUST** identify single points of failure
3. **MANDATORY IMPORTANT MUST** propose mitigation strategies for high-risk items
4. **MANDATORY IMPORTANT MUST** flag security, compliance, and legal implications
5. **MANDATORY IMPORTANT MUST** consider failure modes and blast radius

### Strategic Rules

1. **MANDATORY IMPORTANT MUST** discuss build vs buy vs partner trade-offs
2. **MANDATORY IMPORTANT MUST** consider team capacity and skill gaps
3. **MANDATORY IMPORTANT MUST** address technical debt trajectory (accumulating vs paying down)
4. **MANDATORY IMPORTANT MUST** think about hiring, onboarding, and knowledge transfer
5. **MANDATORY IMPORTANT MUST** align recommendations with business objectives

### Code Rules

1. **MANDATORY IMPORTANT MUST** focus on interfaces and contracts over implementation
2. **MANDATORY IMPORTANT MUST** show only essential code - reference patterns by name
3. **MANDATORY IMPORTANT MUST** include complexity analysis (time, space, operational)
4. **MANDATORY IMPORTANT MUST** design for extensibility and future requirements
5. **MANDATORY IMPORTANT MUST** consider observability, debugging, and incident response

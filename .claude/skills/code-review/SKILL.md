---
name: code-review
description: Use for DEEP code analysis with phased investigation (5 phases), SOLID principle validation, external memory-driven analysis, and comprehensive refactoring plans. Best for major refactoring, architecture compliance, and thorough anti-pattern detection. NOT for quick PR reviews (use tasks-code-review instead).

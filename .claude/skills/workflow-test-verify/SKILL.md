...
**Goal:** [Workflow] Trigger Test Verification & Quality workflow — comprehensive test verification: review quality, diagnose failures, verify traceability, fix flaky tests.
...
- MUST ATTENTION fail verification when tests lack a protected business rule/invariant or cannot fail if it breaks.

...
**Steps:** /scout → /feature-investigation → /debug → /plan → /plan-review → /plan-validate → /why-review → /fix → /prove-fix → /tdd-spec → /tdd-spec-review → /test-specs-docs → /code-simplifier → /review-changes → /review-architecture → /code-review → /performance → /changelog → /test → /docs-update → /watzup → /workflow-end

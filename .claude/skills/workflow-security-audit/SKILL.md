...
**IMPORTANT MANDATORY Steps:** /scout -> /security -> /watzup -> /workflow-end
...
**Goal:** [Workflow] Trigger Security Audit workflow — security review and vulnerability assessment.

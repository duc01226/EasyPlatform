...
**IMPORTANT MANDATORY Steps:** /scout -> /feature-investigation -> /plan -> /plan-review -> /plan-validate -> /code -> /test -> /workflow-review-changes -> /sre-review -> /docs-update -> /watzup -> /workflow-end
...
**Steps:** /scout → /feature-investigation → /plan → /plan-review → /plan-validate → /code → /test → /workflow-review-changes → /sre-review → /docs-update → /watzup → /workflow-end

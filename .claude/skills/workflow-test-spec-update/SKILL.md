...
**IMPORTANT MANDATORY Steps:** /workflow-review-changes -> /tdd-spec -> /tdd-spec-review -> /tdd-spec [direction=sync] -> /integration-test -> /integration-test-review -> /integration-test-verify -> /test -> /docs-update -> /workflow-end
...
**Steps:** /workflow-review-changes → /tdd-spec → /tdd-spec-review → /tdd-spec [direction=sync] → /integration-test → /integration-test-review → /integration-test-verify → /test → /docs-update → /workflow-end

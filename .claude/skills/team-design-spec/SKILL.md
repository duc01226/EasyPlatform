...
- **MUST READ** `.claude/skills/team-design-spec/references/design-system-reference.md` — component specs, accessibility audit template, design tokens, responsive breakpoints, handoff checklist
...
4. **Extract Figma Specs (if link found)**
    - Call `/team-figma-extract {url}` internally
    - Handle failures gracefully (continue without Figma data)

5. **Define Components** (use template from `.claude/skills/team-design-spec/references/design-system-reference.md`)
...
```bash
/team-design-spec https://www.figma.com/design/ABC123/UserProfile
/team-design-spec team-artifacts/pbis/260119-pbi-user-profile.md
```

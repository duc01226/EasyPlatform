...
version: 1.0.0
description: '[Implementation] Bootstrap project with parallel execution'
...
**Goal:** Bootstrap a new project with parallel execution of independent setup phases.

**Workflow:**
1. **Scaffold** — Create project structure and configuration
2. **Parallelize** — Dispatch independent setup tasks to subagents
3. **Integrate** — Merge results and verify project builds
...
- Use `ui-ux-designer` for frontend (generate/analyze assets with `ai-multimodal`, edit with `media-processing`)

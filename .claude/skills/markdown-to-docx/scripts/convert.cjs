 ...
 *
 * Usage:
 *   node convert.cjs --file <input.md> [--output <output.docx>]
 *
 * Options:
 *   --file <path>   Input markdown file (required)
 *   --output <path> Output DOCX path (default: input name + .docx)
 *   --help          Show usage information
 */

const path = require('node:path');
const { convertToDocx, generateOutputPath, resolvePath } = require('./lib/docx-generator.cjs');
...
Examples:
  ...
  node convert.cjs --file ./doc.md --output ./output/doc.docx
`);
}

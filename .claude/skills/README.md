...
- **_templates/template-skill** - A basic template to use as a starting point for new skills
...
Skills are simple to create - just a folder with a `SKILL.md` file containing YAML frontmatter and instructions. You can use the **_templates/template-skill** in this repository as a starting point:

...
**Steps:** /scout → /plan → /plan-review → /fix → /prove-fix → /tdd-spec → /tdd-spec-review → /test-specs-docs → /test → /review-changes → /review-architecture → /sre-review → /watzup → /workflow-end

...
**Steps:** /scout → /feature-investigation → /tdd-spec → /plan → /plan-review → /plan-validate → /why-review → /cook → /integration-test → /test → /code-simplifier → /review-changes → /code-review → /sre-review → /changelog → /docs-update → /watzup → /workflow-end

...
**Steps:** /idea → /refine → /story → /design-spec → /plan → /plan-review → /plan-validate → /cook → /code-simplifier → /review-changes → /code-review → /sre-review → /test-spec → /quality-gate → /docs-update → /watzup → /acceptance → /workflow-end

...
**Steps:** /idea → /refine → /refine-review → /story → /story-review → /pbi-challenge → /dor-gate → /pbi-mockup → /design-spec → /interface-design → /frontend-design → /plan → /plan-review → /plan-validate → /cook → /integration-test → /integration-test-review → /workflow-review-changes → /sre-review → /test-spec → /quality-gate → /docs-update → /watzup → /acceptance → /workflow-end

...
If the user provides screenshots or videos:
- **FIRST** activate `find-component` skill to locate the source component(s) from the screenshot
- Then use `ai-multimodal` skill to describe as detailed as possible the issue, make sure developers can predict the root causes easily based on the description.

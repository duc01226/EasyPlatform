...
SKILL_DIR=""
if [ -d ".claude/skills/test-ui/scripts" ]; then
  SKILL_DIR=".claude/skills/test-ui/scripts"
elif [ -d "$HOME/.claude/skills/test-ui/scripts" ]; then
  SKILL_DIR="$HOME/.claude/skills/test-ui/scripts"
fi
cd "$SKILL_DIR"
```

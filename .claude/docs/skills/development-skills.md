...
> Backend and frontend development skills for YourProject

## Overview

Development skills provide domain-specific knowledge for implementing features in the YourProject monorepo.
...
### ~~`frontend-angular`~~ _(Removed)_

> **Deleted.** Frontend patterns are now handled generically via `docs/project-reference/frontend-patterns-reference.md` (auto-injected by `frontend-context.cjs` hook). No tech-stack-specific skill needed.

#### Component Hierarchy (reference: `docs/project-reference/frontend-patterns-reference.md`)

> **Project Example:** Component hierarchy below uses project-specific base classes. Your project will have its own base component hierarchy — see your frontend patterns reference doc.
...
> **Project Example:** Uses project-specific `AppBaseVmStoreComponent` and store pattern. Adapt to your project's component base class and state management.
...
> **Project Example:** Uses project-specific `AppBaseFormComponent` with built-in validation. Adapt to your project's form base class.
    ...
    protected initialFormConfig = () => ({
        controls: {
            email: new FormControl(
                ...
                [ifAsyncValidator(() => !this.isViewMode, checkEmailUniqueValidator(this.api))]
            )
        },
...
> **Project Example:** Uses project-specific `PlatformVmStore` with `effectSimple()` and reactive selectors. Adapt to your project's state management pattern.
...
> **Project Example:** Store-level caching via project-specific `PlatformVmStore`. Your project may use a different caching mechanism.
...
> **Project Example:** Uses project-specific `PlatformApiService` base class with built-in caching. Adapt to your project's API service base class.
...
Location: _(deleted — see `docs/project-reference/frontend-patterns-reference.md`)_
...
React component library skill for shadcn/ui + Tailwind CSS. For React/Next.js projects only -- NOT for Angular (see `docs/project-reference/frontend-patterns-reference.md`).
...
```scss
// Use design tokens from docs/project-reference/design-system/
...
_Source: `.claude/skills/` | Backend and frontend development skills_

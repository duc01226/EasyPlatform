...
│          │                    │                    ▼                    │
│   ┌──────────────┐     ┌──────────────┐     ┌──────────────┐           │
│   │ SessionEnd  │◀────│ PreCompact   │◀────│ PostToolUse  │           │
│   │    Hooks     │     │    Hooks     │     │    Hooks     │           │
│   └──────────────┘     └──────────────┘     └──────────────┘           │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
...
├─────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│   User Prompt ──▶ UserPromptSubmit ──▶ Claude Processing ──▶ Tool Decision     │
│                                                            │             │
│                                                            ▼             │
│   ┌────────────────────────────────────────────────────────────────┐    │
│   │                      PreToolUse Hooks                           │    │
...
├── todo/todo-state-{id}.json    # Todo list persistence
├── edit/edit-state-{id}.json    # File edit tracking
├── swap/{id}/*.content      # Externalized large outputs
└── markers/{id}.marker.json # Compaction markers
```
...
- [README.md](./README.md) - Hooks overview and lessons system
- [extending-hooks.md](./extending-hooks.md) - Creating custom hooks

---

_Source: `.claude/hooks/` | Architecture reference_

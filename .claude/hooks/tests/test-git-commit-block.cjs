...
// Marker path must match hook: CLAUDE_PROJECT_DIR/tmp/claude-temp/.commit-skill-active
const MARKER_FILE = path.join(PROJECT_DIR, 'tmp', 'claude-temp', '.commit-skill-active');

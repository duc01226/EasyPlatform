...
const { assertEqual, assertContains, assertAllowed, assertTrue, assertNotNullish } = require('../lib/assertions.cjs');
const {
    createTempDir,
    cleanupTempDir,
    setupCheckpoint,
...
module.exports = {
    ...
    tests: [...sessionInitTests, ...sessionResumeTests, ...sessionEndTests, ...subagentInitTests, ...configEdgeCaseTests]
};

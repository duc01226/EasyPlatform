    ...
    fn: async () => {
      ...
      try {
        ...
        assertContains(
          output,
          "Workflow Catalog",
          "Should inject catalog header",
        );
        assertContains(
          output,
          "feature",
          "Catalog should contain feature workflow",
        );
        assertContains(
          output,
          "bugfix",
          "Catalog should contain bugfix workflow",
        );
        assertContains(output, "Use:", "Catalog should contain Use: labels");
        assertContains(
          output,
          "Not for:",
          "Catalog should contain Not for: labels",
        );
      } finally {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertNotContains(
          result.stdout,
          "Workflow Catalog",
          "Should skip catalog for short prompt",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        const input = createUserPromptInput(
          "quick: implement a new feature with auth support",
        );
        const result = await runHook(WORKFLOW_ROUTER, input, { cwd: tmpDir });
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          ...
          "tmpclaude file should exist before cleanup",
        );
        ...
        assertTrue(
          !fs.existsSync(tmpFile),
          "tmpclaude file should be cleaned from .claude/skills",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
  ...
  },
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          !fs.existsSync(tmpFile),
          "tmpclaude file should be cleaned from .claude/hooks",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
  ...
  },
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          !fs.existsSync(tmpFile),
          "tmpclaude file should be cleaned from .claude root",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
  ...
  },
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        tmpFiles.forEach((f) =>
          assertTrue(fs.existsSync(f), `${f} should exist before cleanup`),
        );
        ...
        tmpFiles.forEach((f) =>
          assertTrue(!fs.existsSync(f), `${f} should be cleaned up`),
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          ...
          ".git directory contents should not be touched",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
  ...
  },
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          !fs.existsSync(tmpFile),
          "tmpclaude file should be cleaned from project root",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
  ...
  },
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertAllowed(
          result.code,
          "Should not crash without .claude directory",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
...
const tmpclaudeSessionEndTests = [
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          fs.existsSync(tmpFile),
          "tmpclaude file should exist before session-end",
        );
        ...
        assertTrue(
          !fs.existsSync(tmpFile),
          "tmpclaude file should be cleaned on session exit",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
  ...
  },
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          fs.existsSync(tmpFile),
          "tmpclaude file should exist before session clear",
        );
        ...
        assertTrue(
          !fs.existsSync(tmpFile),
          "tmpclaude file should be cleaned on session clear",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
  ...
  },
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          !fs.existsSync(tmpFile1),
          "skills tmpclaude should be cleaned on session-end",
        );
        assertTrue(
          !fs.existsSync(tmpFile2),
          "hooks tmpclaude should be cleaned on session-end",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
  ...
  },
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertAllowed(
          result.code,
          "session-end should complete without errors",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        assertEqual(
          afterContent,
          originalContent,
          "File in .claude/hooks/ should not be formatted",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        assertEqual(
          afterContent,
          originalContent,
          "File in .claude/skills/ should not be formatted",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        assertEqual(
          afterContent,
          originalContent,
          "Nested .claude/skills/ file should not be formatted",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        assertEqual(
          afterContent,
          originalContent,
          "Written file in .claude/hooks/ should not be formatted",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        assertContains(
          output,
          "[Workflow]",
          "Should include [Workflow] prefix in todo guidance",
        );
        assertContains(
          output,
          "TaskCreate",
          "Should include TaskCreate instruction",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        assertContains(
          output,
          "/scout",
          "Should show /scout command in catalog steps",
        );
        assertContains(
          output,
          "/fix",
          "Should show /fix command in catalog steps",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
...
const edgeCaseTests = [
  {
    ...
    fn: async () => {
      ...
      try {
        ...
        assertTrue(
          fs.existsSync(tmpFile),
          "Deep tmpclaude file should exist before cleanup",
        );
        ...
        assertTrue(
          !fs.existsSync(tmpFile),
          "Deep tmpclaude file should be cleaned",
        );
      } finally {
        cleanupTempDir(tmpDir);
      }
    ...
    fn: async () => {
      ...
      try {
        ...
        validFiles.forEach((f) =>
          fs.writeFileSync(path.join(claudeDir, f), "valid"),
        );
        invalidFiles.forEach((f) =>
          fs.writeFileSync(path.join(claudeDir, f), "invalid"),
        );
        ...
        validFiles.forEach((f) => {
          assertTrue(
            ...
            `Valid pattern ${f} should be cleaned`,
          );
        });
        ...
        invalidFiles.forEach((f) => {
          assertTrue(
            fs.existsSync(path.join(claudeDir, f)),
            `Invalid pattern ${f} should remain`,
          );
        });
      } finally {
        cleanupTempDir(tmpDir);

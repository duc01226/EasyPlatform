...
const { CODE_PATTERNS: DEDUP_MARKER, E2E_CONTEXT: E2E_DEDUP_MARKER, DEDUP_LINES } = require('./lib/dedup-constants.cjs');
const PROJECT_DIR = process.env.CLAUDE_PROJECT_DIR || process.cwd();
const BACKEND_PATTERNS = path.resolve(PROJECT_DIR, 'docs/project-reference/backend-patterns-reference.md');
const FRONTEND_PATTERNS = path.resolve(PROJECT_DIR, 'docs/project-reference/frontend-patterns-reference.md');
...
const E2E_REFERENCE_DOC = e2eConfig.guideDoc ? path.resolve(PROJECT_DIR, e2eConfig.guideDoc) : path.resolve(PROJECT_DIR, 'docs/project-reference/e2e-test-reference.md');

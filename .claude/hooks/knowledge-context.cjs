...
const WORKSPACE_TYPES = [
  {
    ...
    template: "docs/templates/research-report-template.md",
    label: "Research & Synthesis",
  },
  {
    key: "courses",
    pathRegex: /docs[\\/]knowledge[\\/]courses/i,
    template: "docs/templates/course-outline-template.md",
...
function buildInjection(filePath) {
  ...
  lines.push(
    ...
    "> MUST READ `.claude/skills/shared/web-research-protocol.md` for full source hierarchy and citation rules.",
    "",

...
const ROLE_PATH_MAPPINGS = {
    ...
    'team-artifacts/pbis/stories/': {
        ...
        template: '.claude/docs/team-artifacts/templates/user-story-template.md',
...
function findRoleConfig(filePath) {
    ...
    const sortedMappings = Object.entries(ROLE_PATH_MAPPINGS).sort((a, b) => b[0].length - a[0].length);

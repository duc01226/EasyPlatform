...
- Every test case (TC-{FEATURE}-{NNN}) must have `[Source: namespace/service/id]` abstract-anchor evidence; verify the anchor maps to real source in the project's provenance/reference docs

...
This file provides essential context and navigation for AI agents working on EasyPlatform. Detailed patterns and protocols are in `.claude/rules/`.
...
> **Full protocol:** See [.claude/rules/01-planning-protocol.md](.claude/rules/01-planning-protocol.md)
...
| File                                                                       | Purpose                                          |
| -------------------------------------------------------------------------- | ------------------------------------------------ |
| [01-planning-protocol.md](.claude/rules/01-planning-protocol.md)           | Mandatory planning workflow                      |
| [02-investigation-protocol.md](.claude/rules/02-investigation-protocol.md) | Code investigation and debugging                 |
| [03-backend-patterns.md](.claude/rules/03-backend-patterns.md)             | All 13 backend patterns (CQRS, Repository, etc.) |
| [04-frontend-patterns.md](.claude/rules/04-frontend-patterns.md)           | Angular/platform-core patterns                   |
| [05-authorization-patterns.md](.claude/rules/05-authorization-patterns.md) | Security and migration patterns                  |
| [06-decision-trees.md](.claude/rules/06-decision-trees.md)                 | Quick decision guides and templates              |
| [07-advanced-patterns.md](.claude/rules/07-advanced-patterns.md)           | Advanced techniques and anti-patterns            |
| [08-clean-code-rules.md](.claude/rules/08-clean-code-rules.md)             | Universal coding standards                       |
...
> **Detailed patterns:** See [03-backend-patterns.md](.claude/rules/03-backend-patterns.md) and [04-frontend-patterns.md](.claude/rules/04-frontend-patterns.md)
...
> **More decision guides:** See [06-decision-trees.md](.claude/rules/06-decision-trees.md)
...
> **Full protocol:** See [02-investigation-protocol.md](.claude/rules/02-investigation-protocol.md)
...
> **Coding standards:** See [08-clean-code-rules.md](.claude/rules/08-clean-code-rules.md)
...
> **Full anti-patterns:** See [07-advanced-patterns.md](.claude/rules/07-advanced-patterns.md)
...
> **Detailed rules:** See [08-clean-code-rules.md](.claude/rules/08-clean-code-rules.md)
...
3. **Check Rule Files:** `.claude/rules/` for detailed guidance
4. **Read Base Classes:** Check platform-core source for available APIs

---

_For detailed patterns and complete code examples, see the rule files in `.claude/rules/`_
